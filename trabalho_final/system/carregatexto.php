...
#ON Orders.CustomerID=Customers.CustomerID;
	...
	<div id="laranja">
 		<div id="azul">
 			<img style="margin-top:10px" src="<?=$row->ft_perfil?>">
 			<h4><?=$row->nome?></h4>
 			<div id="texto">
			...
			<div id="panel" allign="left" >
				<div class="panel panel-default" style="background:transparent; border:none;">
  					<div id="exib_coment<?=$row->id?>" class="panel-body" style="background:transparent;">
			  	...
			  	<div class="panel-footer">
			  		...
			  		<form action="" method="POST" id="formcoment">
						...
						<input style="margin-top:10px" type="submit" value="Enviar comentário" name="bt<?=$row->id?>"  class="btn btn-default">
					</form>			
				</div>
			</div>
