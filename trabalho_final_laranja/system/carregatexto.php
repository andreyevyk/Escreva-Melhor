 		...
 		<div id="azul">
			...
			<div id="panel" allign="left" >
				<div class="panel panel-default" style="background:transparent; border:none;">
  					<div style="background:transparent; background-color:#f63;" id="exib_coment<?=$row->id?>" class="panel-body" >
  					<input type="text" style="display:none;" name="asd" id="asd" value="<?=$row->id?>" >

			  		</div>
			  	<div class="panel-footer" style="background:transparent; background-color:#f63">
			  		<ol class="breadcrumb">
			  		...
			  		<form action="" method="POST" id="formcoment">
						...
						<input type="submit" value="Enviar comentário" name="bt<?=$row->id?>"  class="btn btn-default">
					</form>			
				</div>
			</div>
